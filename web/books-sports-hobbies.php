...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM anuncios WHERE categoria = 'Livros, Desportos & Hobbies' AND (titulo LIKE '%$search%' OR valor = '$search')";

    if (!empty($minPrice) && !empty($maxPrice)) {
        $sql .= " AND valor >= '$minPrice' AND valor <= '$maxPrice'";
    }
} else {
    $sql = "SELECT * FROM anuncios WHERE categoria = 'Livros, Desportos & Hobbies'";
...
<body>
	...
	<div class="main-banner banner text-center">
	  <div class="container">    
        ...
        <!-- Livros, Desportos e Hobbies -->
        <div class="total-ads main-grid-border">
            <div class="container">
                <ol class="breadcrumb" style="margin-bottom: 5px;">
                    <li><a href="iindex_after_login.html">Inicio</a></li>
                    <li class="active">Livros, Desportos e Hobbies</li>
                </ol>
                <div class="ads-grid">
