...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM anuncios WHERE categoria = 'Electronicos e acessorios' AND (titulo LIKE '%$search%' OR valor = '$search')";

    if (!empty($minPrice) && !empty($maxPrice)) {
        $sql .= " AND valor >= '$minPrice' AND valor <= '$maxPrice'";
    }
} else {
    $sql = "SELECT * FROM anuncios WHERE categoria = 'Electronicos e acessorios'";
        ...
        <div class="total-ads main-grid-border">
            <div class="container">
                <ol class="breadcrumb" style="margin-bottom: 5px;">
                    ...
                    <li class="active">Eletronicos e acessorios</li>
                </ol>
                <div class="ads-grid">
